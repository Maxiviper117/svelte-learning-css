    ...
    <div class="wrapper">
        <article>
            <header class="text-center">
                <h1 class="page-title">
                    Get the most of of your mobile with the right subscription
                </h1>
                <p class="subtitle">
                    All devices come with free delivery or pickup as standard.
                    See information on available shopping options for your
                    location.
                </p>
            </header>
    ...
    .plan {
        ...
        */
        ...
        box-shadow: 0 0 1rem rgb(0 0 0 / 0.122),
            -1.25rem -1.25rem 0 0 var(--_shadow);
    }
